		...
		<nav class="navbar is-transparent mt-4">
				<div class="navbar-brand">
					...
					<router-link class="navbar-item" to="/main">
						<img src="../assets/img/shandobako_colorful.png" alt="shandobako: a smart predicting device"
							width="180" height="30">
					</router-link>
					
					<div class="flex-grow" />
					<span class="is-hidden1">
					<el-dropdown 
					@command="handleCommand">
						<span class="el-dropdown-link" style="width: 30px; height: 30px;">
							<el-icon class="el-icon--right" style="font-size: 50px;">
								<!-- <arrow-down :size="20"/> -->
								<Fold />
							</el-icon>
						</span>
						...
						<template #dropdown>
							...
							<!-- <el-dropdown-item>
								<a class="navbar-item" style="color: blue;" href="https://www.baidu.com">
									进入社区
								</a>
							</el-dropdown-item> -->
						</el-dropdown-menu>
				...
				<div id="superCDH" class="navbar-menu">
					...
					<p class="control">
						<span class="navbar-item">
							...
							<router-link v-if="$route.path != '/login' && $store.state.token == ''"
								class="button is-info is-rounded" to="/login">
								<span>登录</span>
							</router-link>
	...
	<div :hidden="store.state.pdf">
		...
		<div class="content has-text-centered" >
			<p>
				...
				<br><img class="img" style="border: 0;padding-right: 5px;"
